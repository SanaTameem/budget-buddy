...
- [Live Demo Link](https://budget-buddy-b9fl.onrender.com/)
...
- Install <a href="https://rubyonrails.org/">Ruby On Rails</a> using `rails new budget-buddy --database=postgresql` command.
```sh
  cd my-project
  bundle install
```
...
Feel free to check the [issues page](https://github.com/SanaTameem/budget-buddy/issues).
